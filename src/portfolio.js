const header = {
    homepage: 'https://harshithap2000.github.io/my-portfolio',  
    title: 'HP.',
  }
  
  const about = {
    name: 'Harshitha Prakash',
    role: 'Software Engineer',
    description:
      'Aspiring software engineer with experience in machine learning, big data, and software development. Specializes in creating efficient solutions and solving complex problems.',
    resume: '/Harshitha Prakash Resume.pdf',  
    social: {
  ...
  const projects = [
    {
      name: 'Petri Net Modelling of Railway Networks',
      description:
  ...
  const contact = {
    email: 'harshitha.prakash22@gmail.com',  
  }
